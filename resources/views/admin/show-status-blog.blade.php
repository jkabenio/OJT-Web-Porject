...
<style>
  ...
  #input-status-search-id::placeholder {
      color: #aaa;
      font-style: italic;
      font-size: 14px;
  }
...
<main class="main-container">
    ...
    <h4 class="main-title">Status Blog List</h4>
    <br><br>
    @php
    $row_count = 1;
@endphp
...
<table>
    <thead>
        <tr>
            <div class="search-wrapper">
                <input type="search" name="statussearch" id="input-status-search-id" placeholder="Search by: Title or Description"/>
            </div>
            <th>No.</th>
            <th>Description</th>
            <th>Edit</th>
    ...
    <tbody id="tbody-status-search-id">
